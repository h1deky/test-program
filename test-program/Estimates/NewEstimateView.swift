...
struct NewEstimateView: View {
    ...
    @State private var estimateNumber: String = "EST-1001"
    ...
    var body: some View {
        NavigationStack {
            ...
            .sheet(isPresented: $isCatalogPresented) {
                ComingSoonView(title: "Catalog", message: "Каталог пока заглушка.")
            }
            .sheet(isPresented: $isTaxDiscountPresented) {
                ComingSoonView(title: "Tax & Discount", message: "Налоги/скидки пока заглушка.")
            }
