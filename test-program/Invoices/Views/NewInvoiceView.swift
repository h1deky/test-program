...
struct NewInvoiceView: View {
    ...
    private var invoiceNumberSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text("Invoice Number")
                .font(.subheadline)
            TextField("", text: $viewModel.invoiceNumber)
                .formFieldStyle()
        }
    }
    ...
    private var previewSection: some View {
        VStack(alignment: .leading, spacing: 20) {
            previewHeader(title: "Invoice Preview", number: viewModel.invoiceNumber)
    ...
    private var sendSection: some View {
        VStack(alignment: .leading, spacing: 20) {
            previewHeader(title: "Send Invoice", number: viewModel.invoiceNumber)
    ...
    private func sheetView(for sheet: InvoiceSheet) -> some View {
