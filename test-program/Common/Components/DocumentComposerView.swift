...
struct DocumentComposerView: View {
    ...
    @ObservedObject var viewModel: DocumentComposerViewModel
    ...
    private var numberSection: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text(viewModel.kind.numberTitle)
                .font(.subheadline)
    ...
    private var previewSection: some View {
        VStack(alignment: .leading, spacing: 20) {
            previewHeader(title: viewModel.kind.previewTitle, number: viewModel.documentNumber)
    ...
    private var sendSection: some View {
        VStack(alignment: .leading, spacing: 20) {
            previewHeader(title: viewModel.kind.sendTitle, number: viewModel.documentNumber)
            ...
            actionTile(
                title: viewModel.kind.primarySendActionTitle,
                subtitle: viewModel.kind.primarySendActionSubtitle
            )
    ...
    private func sheetView(for sheet: DocumentComposerSheet) -> some View {
        ComingSoonView(title: sheet.title, message: sheet.message(for: viewModel.kind))
    }
}
